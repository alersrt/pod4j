...
- API version: 5.0.0
  - Build date: 2024-12-28T02:27:12.403969908+07:00[Asia/Barnaul]
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'pod4j.openapi-java' jar has been published to maven central.
    mavenLocal()       // Needed if the 'pod4j.openapi-java' jar has been published to the local maven repo.
  }
