...
> ImageBuild200Response imageBuild(contentType, xRegistryConfig, dockerfile, t, extrahosts, remote, retry, retryDelay,
> q, compatvolumes, nocache, cachefrom, pull, rm, forcerm, memory, memswap, cpushares, cpusetcpus, cpuperiod, cpuquota,
> buildargs, shmsize, squash, labels, networkmode, platform, target, outputs, inputStream)
