...
> networkConnectLibpod(name, create)
...
> networkDisconnectLibpod(name, create)
...
Display summary of network configurations. - In a 200 response, all of the fields named Bytes are returned as a Base64
encoded string.
...
> networkUpdateLibpod(name, update)
