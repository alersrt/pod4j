...
public class ExecCompatApi {
     ...
     * </table>
     */
    public okhttp3.Call containerExecCall(
    ...
    private okhttp3.Call containerExecValidateBeforeCall(
            String name, ContainerExecRequest control, final ApiCallback _callback)
            throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException(
                    "Missing the required parameter 'name' when calling containerExec(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<Void> containerExecWithHttpInfo(String name, ContainerExecRequest control)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call containerExecAsync(
     ...
     * </table>
     */
    public okhttp3.Call execInspectCall(String id, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call execInspectValidateBeforeCall(String id, final ApiCallback _callback)
            throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException(
                    "Missing the required parameter 'id' when calling execInspect(Async)");
        }
     ...
     * </table>
     */
    public okhttp3.Call execInspectAsync(String id, final ApiCallback<InspectExecSession> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call execResizeCall(
            String id, Integer h, Integer w, Boolean running, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call execResizeValidateBeforeCall(
            String id, Integer h, Integer w, Boolean running, final ApiCallback _callback)
            throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException(
                    "Missing the required parameter 'id' when calling execResize(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<Void> execResizeWithHttpInfo(
            String id, Integer h, Integer w, Boolean running) throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call execResizeAsync(
            String id, Integer h, Integer w, Boolean running, final ApiCallback<Void> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call execStartCall(
            String id, ExecStartRequest control, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call execStartValidateBeforeCall(
            String id, ExecStartRequest control, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException(
                    "Missing the required parameter 'id' when calling execStart(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<Void> execStartWithHttpInfo(String id, ExecStartRequest control)
            throws ApiException {
     ...
     * an interactive session with the command.
     *
     * @param id Exec instance ID (required)
     * @param control Attributes for start (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * </table>
     */
    public okhttp3.Call execStartAsync(
            String id, ExecStartRequest control, final ApiCallback<Void> _callback)
            throws ApiException {
