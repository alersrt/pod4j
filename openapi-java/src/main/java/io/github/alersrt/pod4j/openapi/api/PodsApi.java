...
public class PodsApi {
     ...
     * </table>
     */
    public okhttp3.Call podCreateLibpodCall(PodSpecGenerator create, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call podCreateLibpodValidateBeforeCall(
            PodSpecGenerator create, final ApiCallback _callback) throws ApiException {
     ...
     * </table>
     */
    public ApiResponse<IdResponse> podCreateLibpodWithHttpInfo(PodSpecGenerator create)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podCreateLibpodAsync(
            PodSpecGenerator create, final ApiCallback<IdResponse> _callback) throws ApiException {
     ...
     * @param force force removal of a running pod by first stopping all containers, then removing
     *     all containers in the pod (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * </table>
     */
    public okhttp3.Call podDeleteLibpodCall(String name, Boolean force, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call podDeleteLibpodValidateBeforeCall(
            String name, Boolean force, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException(
                    "Missing the required parameter 'name' when calling podDeleteLibpod(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<PodRmReport> podDeleteLibpodWithHttpInfo(String name, Boolean force)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podDeleteLibpodAsync(
            String name, Boolean force, final ApiCallback<PodRmReport> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podExistsLibpodCall(String name, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call podExistsLibpodValidateBeforeCall(String name, final ApiCallback _callback)
            throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException(
                    "Missing the required parameter 'name' when calling podExistsLibpod(Async)");
        }
    ...
    /**
     * Pod exists Check if a pod exists by name or ID
     *
     * @param name the name or ID of the pod (required)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
     *     response body
    ...
    /**
     * Pod exists (asynchronously) Check if a pod exists by name or ID
     *
     * @param name the name or ID of the pod (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * </table>
     */
    public okhttp3.Call podExistsLibpodAsync(String name, final ApiCallback<Void> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podInspectLibpodCall(String name, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call podInspectLibpodValidateBeforeCall(
            String name, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException(
                    "Missing the required parameter 'name' when calling podInspectLibpod(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<InspectPodData> podInspectLibpodWithHttpInfo(String name)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podInspectLibpodAsync(
            String name, final ApiCallback<InspectPodData> _callback) throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podKillLibpodCall(String name, String signal, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call podKillLibpodValidateBeforeCall(
            String name, String signal, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException(
                    "Missing the required parameter 'name' when calling podKillLibpod(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<PodKillReport> podKillLibpodWithHttpInfo(String name, String signal)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podKillLibpodAsync(
            String name, String signal, final ApiCallback<PodKillReport> _callback)
            throws ApiException {
     ...
     *
     * @param filters JSON encoded value of the filters (a map[string][]string) to process on the
     *     pods list. Available filters: - &#x60;id&#x3D;&lt;pod-id&gt;&#x60; Matches all of pod id.
     *     - &#x60;label&#x3D;&lt;key&gt;&#x60; or &#x60;label&#x3D;&lt;key&gt;:&lt;value&gt;&#x60;
     *     Matches pods based on the presence of a label alone or a label and a value. -
     *     &#x60;name&#x3D;&lt;pod-name&gt;&#x60; Matches all of pod name. -
     *     &#x60;until&#x3D;&lt;timestamp&gt;&#x60; List pods created before this timestamp. The
     *     &#x60;&lt;timestamp&gt;&#x60; can be Unix timestamps, date formatted timestamps, or Go
     *     duration strings (e.g. &#x60;10m&#x60;, &#x60;1h30m&#x60;) computed relative to the
     *     daemon machine’s time. - &#x60;status&#x3D;&lt;pod-status&gt;&#x60; Pod&#39;s status:
     *     &#x60;stopped&#x60;, &#x60;running&#x60;, &#x60;paused&#x60;, &#x60;exited&#x60;,
     ...
     * </table>
     */
    public okhttp3.Call podListLibpodCall(String filters, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call podListLibpodValidateBeforeCall(
     ...
     * </table>
     */
    public ApiResponse<List<ListPodsReport>> podListLibpodWithHttpInfo(String filters)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podListLibpodAsync(
            String filters, final ApiCallback<List<ListPodsReport>> _callback) throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podPauseLibpodCall(String name, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call podPauseLibpodValidateBeforeCall(String name, final ApiCallback _callback)
            throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException(
                    "Missing the required parameter 'name' when calling podPauseLibpod(Async)");
        }
    ...
    /**
     * Pause a pod (asynchronously) Pause a pod
     *
     * @param name the name or ID of the pod (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * </table>
     */
    public okhttp3.Call podPauseLibpodAsync(
            String name, final ApiCallback<PodPauseReport> _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call podPruneLibpodValidateBeforeCall(final ApiCallback _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podPruneLibpodAsync(final ApiCallback<PodPruneReport> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podRestartLibpodCall(String name, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call podRestartLibpodValidateBeforeCall(
            String name, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException(
                    "Missing the required parameter 'name' when calling podRestartLibpod(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<PodRestartReport> podRestartLibpodWithHttpInfo(String name)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podRestartLibpodAsync(
            String name, final ApiCallback<PodRestartReport> _callback) throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podStartLibpodCall(String name, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call podStartLibpodValidateBeforeCall(String name, final ApiCallback _callback)
            throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException(
                    "Missing the required parameter 'name' when calling podStartLibpod(Async)");
        }
     ...
     * </table>
     */
    public okhttp3.Call podStartLibpodAsync(
            String name, final ApiCallback<PodStartReport> _callback) throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podStatsAllLibpodCall(
            Boolean all, List<String> namesOrIDs, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
        ...
        if (namesOrIDs != null) {
            localVarCollectionQueryParams.addAll(
                    localVarApiClient.parameterToPairs("csv", "namesOrIDs", namesOrIDs));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call podStatsAllLibpodValidateBeforeCall(
            Boolean all, List<String> namesOrIDs, final ApiCallback _callback) throws ApiException {
        return podStatsAllLibpodCall(all, namesOrIDs, _callback);
    }

    /**
     * Statistics for one or more pods Display a live stream of resource usage statistics for the
     ...
     * </table>
     */
    public List<PodStatsReport> podStatsAllLibpod(Boolean all, List<String> namesOrIDs)
            throws ApiException {
        ApiResponse<List<PodStatsReport>> localVarResp =
                podStatsAllLibpodWithHttpInfo(all, namesOrIDs);
        return localVarResp.getData();
    }
     ...
     * </table>
     */
    public ApiResponse<List<PodStatsReport>> podStatsAllLibpodWithHttpInfo(
            Boolean all, List<String> namesOrIDs) throws ApiException {
    ...
    /**
     * Statistics for one or more pods (asynchronously) Display a live stream of resource usage
     * statistics for the containers in one or more pods
     *
     * @param all Provide statistics for all running pods. (optional)
     * @param namesOrIDs Names or IDs of pods. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * </table>
     */
    public okhttp3.Call podStatsAllLibpodAsync(
            Boolean all, List<String> namesOrIDs, final ApiCallback<List<PodStatsReport>> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podStopLibpodCall(String name, Integer t, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call podStopLibpodValidateBeforeCall(
            String name, Integer t, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException(
                    "Missing the required parameter 'name' when calling podStopLibpod(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<PodStopReport> podStopLibpodWithHttpInfo(String name, Integer t)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podStopLibpodAsync(
            String name, Integer t, final ApiCallback<PodStopReport> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podTopLibpodCall(
            String name, Boolean stream, Integer delay, String psArgs, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call podTopLibpodValidateBeforeCall(
            String name, Boolean stream, Integer delay, String psArgs, final ApiCallback _callback)
            throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException(
                    "Missing the required parameter 'name' when calling podTopLibpod(Async)");
        }
    ...
    /**
     * List processes List processes running inside a pod
     *
     * @param name Name of pod to query for processes (required)
     * @param stream when true, repeatedly stream the latest output (As of version 4.0) (optional)
     * @param delay if streaming, delay in seconds between updates. Must be &gt;1. (As of version
     ...
     * </table>
     */
    public PodTopOKBody podTopLibpod(String name, Boolean stream, Integer delay, String psArgs)
            throws ApiException {
        ApiResponse<PodTopOKBody> localVarResp =
                podTopLibpodWithHttpInfo(name, stream, delay, psArgs);
        return localVarResp.getData();
    }
     ...
     * </table>
     */
    public ApiResponse<PodTopOKBody> podTopLibpodWithHttpInfo(
            String name, Boolean stream, Integer delay, String psArgs) throws ApiException {
        okhttp3.Call localVarCall =
                podTopLibpodValidateBeforeCall(name, stream, delay, psArgs, null);
        Type localVarReturnType = new TypeToken<PodTopOKBody>() {}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List processes (asynchronously) List processes running inside a pod
     *
     * @param name Name of pod to query for processes (required)
     * @param stream when true, repeatedly stream the latest output (As of version 4.0) (optional)
     * @param delay if streaming, delay in seconds between updates. Must be &gt;1. (As of version
     ...
     * </table>
     */
    public okhttp3.Call podTopLibpodAsync(
            String name,
            Boolean stream,
            Integer delay,
            String psArgs,
            final ApiCallback<PodTopOKBody> _callback)
            throws ApiException {

        okhttp3.Call localVarCall =
                podTopLibpodValidateBeforeCall(name, stream, delay, psArgs, _callback);
        Type localVarReturnType = new TypeToken<PodTopOKBody>() {}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * </table>
     */
    public okhttp3.Call podUnpauseLibpodCall(String name, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call podUnpauseLibpodValidateBeforeCall(
            String name, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException(
                    "Missing the required parameter 'name' when calling podUnpauseLibpod(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<PodUnpauseReport> podUnpauseLibpodWithHttpInfo(String name)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call podUnpauseLibpodAsync(
            String name, final ApiCallback<PodUnpauseReport> _callback) throws ApiException {
