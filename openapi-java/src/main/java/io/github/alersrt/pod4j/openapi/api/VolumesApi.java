...
public class VolumesApi {
     ...
     * </table>
     */
    public okhttp3.Call volumeCreateLibpodCall(
            VolumeCreateOptions create, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call volumeCreateLibpodValidateBeforeCall(
            VolumeCreateOptions create, final ApiCallback _callback) throws ApiException {
     ...
     * </table>
     */
    public ApiResponse<VolumeConfigResponse> volumeCreateLibpodWithHttpInfo(
            VolumeCreateOptions create) throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call volumeCreateLibpodAsync(
            VolumeCreateOptions create, final ApiCallback<VolumeConfigResponse> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call volumeDeleteLibpodCall(
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call volumeDeleteLibpodValidateBeforeCall(
            String name, Boolean force, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException(
                    "Missing the required parameter 'name' when calling volumeDeleteLibpod(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<Void> volumeDeleteLibpodWithHttpInfo(String name, Boolean force)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call volumeDeleteLibpodAsync(
            String name, Boolean force, final ApiCallback<Void> _callback) throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call volumeExistsLibpodCall(String name, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call volumeExistsLibpodValidateBeforeCall(
            String name, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException(
                    "Missing the required parameter 'name' when calling volumeExistsLibpod(Async)");
        }
    ...
    /**
     * Volume exists Check if a volume exists
     *
     * @param name the name of the volume (required)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
     *     response body
    ...
    /**
     * Volume exists (asynchronously) Check if a volume exists
     *
     * @param name the name of the volume (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * </table>
     */
    public okhttp3.Call volumeExistsLibpodAsync(String name, final ApiCallback<Void> _callback)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call volumeInspectLibpodCall(String name, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call volumeInspectLibpodValidateBeforeCall(
            String name, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException(
                    "Missing the required parameter 'name' when calling"
                            + " volumeInspectLibpod(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<VolumeConfigResponse> volumeInspectLibpodWithHttpInfo(String name)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call volumeInspectLibpodAsync(
            String name, final ApiCallback<VolumeConfigResponse> _callback) throws ApiException {
     ...
     *     volumes list. Available filters: - driver&#x3D;&lt;volume-driver-name&gt; Matches volumes
     *     based on their driver. - label&#x3D;&lt;key&gt; or label&#x3D;&lt;key&gt;:&lt;value&gt;
     ...
     * </table>
     */
    public okhttp3.Call volumeListLibpodCall(String filters, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    public List<VolumeConfigResponse> volumeListLibpod(String filters) throws ApiException {
        ApiResponse<List<VolumeConfigResponse>> localVarResp =
                volumeListLibpodWithHttpInfo(filters);
        return localVarResp.getData();
    }
     ...
     * </table>
     */
    public ApiResponse<List<VolumeConfigResponse>> volumeListLibpodWithHttpInfo(String filters)
            throws ApiException {
    ...
    /**
     * List volumes (asynchronously) Returns a list of volumes
     *
     * @param filters JSON encoded value of the filters (a map[string][]string) to process on the
     *     volumes list. Available filters: - driver&#x3D;&lt;volume-driver-name&gt; Matches volumes
     *     based on their driver. - label&#x3D;&lt;key&gt; or label&#x3D;&lt;key&gt;:&lt;value&gt;
     ...
     * </table>
     */
    public okhttp3.Call volumeListLibpodAsync(
            String filters, final ApiCallback<List<VolumeConfigResponse>> _callback)
            throws ApiException {
     ...
     *
     * @param filters JSON encoded value of filters (a map[string][]string) to match volumes against
     *     before pruning. Available filters: - &#x60;until&#x3D;&lt;timestamp&gt;&#x60; Prune
     *     volumes created before this timestamp. The &#x60;&lt;timestamp&gt;&#x60; can be Unix
     ...
     * </table>
     */
    public okhttp3.Call volumePruneLibpodCall(String filters, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call volumePruneLibpodValidateBeforeCall(
            String filters, final ApiCallback _callback) throws ApiException {
     ...
     * </table>
     */
    public ApiResponse<List<PruneReport>> volumePruneLibpodWithHttpInfo(String filters)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call volumePruneLibpodAsync(
            String filters, final ApiCallback<List<PruneReport>> _callback) throws ApiException {
