...
public class AutoUserNsOptions {
    ...
    /**
     * AdditionalGIDMappings specified additional GID mappings to include in the generated user
     * namespace.
     *
    ...
    /**
     * AdditionalUIDMappings specified additional UID mappings to include in the generated user
     * namespace.
     *
    ...
    /**
     * InitialSize defines the minimum size for the user namespace. The created user namespace will
    ...
    /**
     * Size defines the size for the user namespace. If it is set to a value bigger than 0, the user
     * namespace will have exactly this size. If it is not set, some heuristics will be used to find
     * its size.
     *
     * @return size
     */
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.additionalGIDMappings, autoUserNsOptions.additionalGIDMappings)
                && Objects.equals(
                        this.additionalUIDMappings, autoUserNsOptions.additionalUIDMappings)
    ...
    public String toString() {
        ...
        sb.append("    additionalGIDMappings: ")
                .append(toIndentedString(additionalGIDMappings))
                .append("\n");
        sb.append("    additionalUIDMappings: ")
                .append(toIndentedString(additionalUIDMappings))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AutoUserNsOptions.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in AutoUserNsOptions is not found in the"
                                        + " empty JSON string",
                                AutoUserNsOptions.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `AutoUserNsOptions` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        if (jsonObj.get("AdditionalGIDMappings") != null
                && !jsonObj.get("AdditionalGIDMappings").isJsonNull()) {
            JsonArray jsonArrayadditionalGIDMappings =
                    jsonObj.getAsJsonArray("AdditionalGIDMappings");
            if (jsonArrayadditionalGIDMappings != null) {
                // ensure the json data is an array
                if (!jsonObj.get("AdditionalGIDMappings").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `AdditionalGIDMappings` to be an array in"
                                            + " the JSON string but got `%s`",
                                    jsonObj.get("AdditionalGIDMappings").toString()));
                }
        ...
        if (jsonObj.get("AdditionalUIDMappings") != null
                && !jsonObj.get("AdditionalUIDMappings").isJsonNull()) {
            JsonArray jsonArrayadditionalUIDMappings =
                    jsonObj.getAsJsonArray("AdditionalUIDMappings");
            if (jsonArrayadditionalUIDMappings != null) {
                // ensure the json data is an array
                if (!jsonObj.get("AdditionalUIDMappings").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `AdditionalUIDMappings` to be an array in"
                                            + " the JSON string but got `%s`",
                                    jsonObj.get("AdditionalUIDMappings").toString()));
                }
        ...
        if ((jsonObj.get("GroupFile") != null && !jsonObj.get("GroupFile").isJsonNull())
                && !jsonObj.get("GroupFile").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `GroupFile` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("GroupFile").toString()));
        }
        if ((jsonObj.get("PasswdFile") != null && !jsonObj.get("PasswdFile").isJsonNull())
                && !jsonObj.get("PasswdFile").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `PasswdFile` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("PasswdFile").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<AutoUserNsOptions>() {
                        @Override
                        public void write(JsonWriter out, AutoUserNsOptions value)
                                throws IOException {
