...
public class CapacityRange {
    ...
    /**
     * LimitBytes specifies that a volume must not be bigger than this. The value of 0 indicates an
     * unspecified maximum
     *
     * @return limitBytes
     */
    ...
    /**
     * RequiredBytes specifies that a volume must be at least this big. The value of 0 indicates an
     * unspecified minimum.
     *
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CapacityRange.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CapacityRange is not found in the"
                                        + " empty JSON string",
                                CapacityRange.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `CapacityRange` properties. JSON: %s",
