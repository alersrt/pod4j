...
public class ClusterVolumeSpec {
    ...
    public static final String SERIALIZED_NAME_ACCESSIBILITY_REQUIREMENTS =
    ...
    public ClusterVolumeSpec accessibilityRequirements(
    ...
    /**
     * Secrets defines Swarm Secrets that are passed to the CSI storage plugin when operating on
     * this volume.
     *
     * @return secrets
     */
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.accessMode, clusterVolumeSpec.accessMode)
                && Objects.equals(
                        this.accessibilityRequirements, clusterVolumeSpec.accessibilityRequirements)
    ...
    public int hashCode() {
        return Objects.hash(
                accessMode, accessibilityRequirements, availability, capacityRange, group, secrets);
    }
    ...
    public String toString() {
        ...
        sb.append("    accessibilityRequirements: ")
                .append(toIndentedString(accessibilityRequirements))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ClusterVolumeSpec.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ClusterVolumeSpec is not found in the"
                                        + " empty JSON string",
                                ClusterVolumeSpec.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ClusterVolumeSpec` properties. JSON: %s",
        ...
        if (jsonObj.get("AccessibilityRequirements") != null
                && !jsonObj.get("AccessibilityRequirements").isJsonNull()) {
        ...
        if ((jsonObj.get("Availability") != null && !jsonObj.get("Availability").isJsonNull())
            ...
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Availability` to be a primitive type in the JSON"
                                    + " string but got `%s`",
        ...
        if ((jsonObj.get("Group") != null && !jsonObj.get("Group").isJsonNull())
            ...
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Group` to be a primitive type in the JSON string"
                                    + " but got `%s`",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ClusterVolumeSpec>() {
                        @Override
                        public void write(JsonWriter out, ClusterVolumeSpec value)
                                throws IOException {
