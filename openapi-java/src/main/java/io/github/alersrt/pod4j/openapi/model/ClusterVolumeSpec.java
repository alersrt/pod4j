...
public class ClusterVolumeSpec {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ClusterVolumeSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterVolumeSpec is not found in the empty JSON string", ClusterVolumeSpec.openapiRequiredFields));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!ClusterVolumeSpec.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClusterVolumeSpec` properties. JSON: %s", entry.getKey(), jsonElement));
            }
        }
    ...
    public String toString() {
        String sb = "class ClusterVolumeSpec {\n" +
                "    accessMode: " + toIndentedString(accessMode) + "\n" +
                "    accessibilityRequirements: " + toIndentedString(accessibilityRequirements) + "\n" +
                "    availability: " + toIndentedString(availability) + "\n" +
                "    capacityRange: " + toIndentedString(capacityRange) + "\n" +
