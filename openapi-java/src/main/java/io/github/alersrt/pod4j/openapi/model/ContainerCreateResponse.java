 ...
 */
@JsonPropertyOrder({
  ContainerCreateResponse.JSON_PROPERTY_ID,
  ContainerCreateResponse.JSON_PROPERTY_WARNINGS
})
...
public class ContainerCreateResponse {
  ...
  /**
   * Return true if this ContainerCreateResponse object is equal to o.
   */
  @Override
