...
/**
 * ContainerHealthCheckConfig describes a container healthcheck with attributes like command,
 * retries, interval, start period, and timeout.
 */
...
public class ContainerHealthCheckConfig {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ContainerHealthCheckConfig.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ContainerHealthCheckConfig is not"
                                        + " found in the empty JSON string",
                                ContainerHealthCheckConfig.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ContainerHealthCheckConfig` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ContainerHealthCheckConfig.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ContainerHealthCheckConfig' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ContainerHealthCheckConfig>() {
                        @Override
                        public void write(JsonWriter out, ContainerHealthCheckConfig value)
                                throws IOException {
