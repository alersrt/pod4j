...
public class ContainerJSON {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ContainerJSON.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ContainerJSON is not found in the"
                                        + " empty JSON string",
                                ContainerJSON.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ContainerJSON` properties. JSON: %s",
        ...
        if ((jsonObj.get("LogPath") != null && !jsonObj.get("LogPath").isJsonNull())
                && !jsonObj.get("LogPath").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `LogPath` to be a primitive type in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("LogPath").toString()));
        }
        ...
        if ((jsonObj.get("Platform") != null && !jsonObj.get("Platform").isJsonNull())
                && !jsonObj.get("Platform").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
