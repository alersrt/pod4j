...
/**
 * ContainerSecurityConfig is a container&#39;s security features, including SELinux, Apparmor, and
 * Seccomp.
 */
...
public class ContainerSecurityConfig {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.apparmorProfile, containerSecurityConfig.apparmorProfile)
                ...
                && Objects.equals(
                        this.readOnlyFilesystem, containerSecurityConfig.readOnlyFilesystem)
                ...
                && Objects.equals(
                        this.seccompProfilePath, containerSecurityConfig.seccompProfilePath)
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ContainerSecurityConfig.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ContainerSecurityConfig is not found"
                                        + " in the empty JSON string",
                                ContainerSecurityConfig.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ContainerSecurityConfig` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ContainerSecurityConfig.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ContainerSecurityConfig' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ContainerSecurityConfig>() {
                        @Override
                        public void write(JsonWriter out, ContainerSecurityConfig value)
                                throws IOException {
