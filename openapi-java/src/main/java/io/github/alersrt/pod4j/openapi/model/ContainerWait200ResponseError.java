...
public class ContainerWait200ResponseError {
    ...
    public boolean equals(Object o) {
        ...
        ContainerWait200ResponseError containerWait200ResponseError =
                (ContainerWait200ResponseError) o;
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ContainerWait200ResponseError.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ContainerWait200ResponseError is not"
                                        + " found in the empty JSON string",
                                ContainerWait200ResponseError.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ContainerWait200ResponseError` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ContainerWait200ResponseError.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ContainerWait200ResponseError' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ContainerWait200ResponseError> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(ContainerWait200ResponseError.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ContainerWait200ResponseError>() {
                        @Override
                        public void write(JsonWriter out, ContainerWait200ResponseError value)
                                throws IOException {
                        ...
                        @Override
                        public ContainerWait200ResponseError read(JsonReader in)
                                throws IOException {
