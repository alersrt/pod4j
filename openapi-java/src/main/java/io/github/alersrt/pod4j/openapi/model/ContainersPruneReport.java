...
public class ContainersPruneReport {
    ...
    public String toString() {
        ...
        sb.append("    containersDeleted: ")
                .append(toIndentedString(containersDeleted))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ContainersPruneReport.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ContainersPruneReport is not found in"
                                        + " the empty JSON string",
                                ContainersPruneReport.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ContainersPruneReport` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        // ensure the optional json data is an array if present
        if (jsonObj.get("ContainersDeleted") != null
                && !jsonObj.get("ContainersDeleted").isJsonNull()
                && !jsonObj.get("ContainersDeleted").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `ContainersDeleted` to be an array in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("ContainersDeleted").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ContainersPruneReport>() {
                        @Override
                        public void write(JsonWriter out, ContainersPruneReport value)
                                throws IOException {
