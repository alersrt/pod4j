 ...
 */
@JsonPropertyOrder({
  DeviceRequest.JSON_PROPERTY_CAPABILITIES,
  DeviceRequest.JSON_PROPERTY_COUNT,
  DeviceRequest.JSON_PROPERTY_DEVICE_I_DS,
...
public class DeviceRequest {
  ...
  public static final String JSON_PROPERTY_DEVICE_I_DS = "DeviceIDs";
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `DeviceIDs` to the URL query string
    if (getDeviceIDs() != null) {
      for (int i = 0; i < getDeviceIDs().size(); i++) {
        joiner.add(String.format("%sDeviceIDs%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
            URLEncoder.encode(ApiClient.valueToString(getDeviceIDs().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }
