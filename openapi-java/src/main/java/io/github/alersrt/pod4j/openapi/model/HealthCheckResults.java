...
public class HealthCheckResults {
    ...
    private List<HealthCheckLog> log = new ArrayList<>();
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!HealthCheckResults.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in HealthCheckResults is not found in the"
                                        + " empty JSON string",
                                HealthCheckResults.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `HealthCheckResults` properties. JSON: %s",
        ...
        if (jsonObj.get("Log") != null && !jsonObj.get("Log").isJsonNull()) {
            ...
            if (jsonArraylog != null) {
                ...
                if (!jsonObj.get("Log").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `Log` to be an array in the JSON string but"
                                            + " got `%s`",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<HealthCheckResults>() {
                        @Override
                        public void write(JsonWriter out, HealthCheckResults value)
                                throws IOException {
