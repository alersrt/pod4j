...
@JsonPropertyOrder({
  ...
  HealthcheckConfig.JSON_PROPERTY_RETRIES,
  HealthcheckConfig.JSON_PROPERTY_START_INTERVAL,
  HealthcheckConfig.JSON_PROPERTY_START_PERIOD,
  HealthcheckConfig.JSON_PROPERTY_TEST,
