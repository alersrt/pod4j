...
/**
 * IDMappingOptions are used for specifying how ID mapping should be set up for a layer or
 * container.
 */
...
public class IDMappingOptions {
    ...
    /**
     * UIDMap and GIDMap are used for setting up a layer&#39;s root filesystem for use inside of a
     * user namespace where ID mapping is being used. If HostUIDMapping/HostGIDMapping is true, no
     * mapping of the respective type will be used. Otherwise, if UIDMap and/or GIDMap contain at
     * least one mapping, one or both will be used. By default, if neither of those conditions
     * apply, if the layer has a parent layer, the parent layer&#39;s mapping will be used, and if
     * it does not have a parent layer, the mapping which was passed to the Store object when it was
    ...
    public int hashCode() {
        return Objects.hash(
                autoUserNs, autoUserNsOpts, giDMap, hostGIDMapping, hostUIDMapping, uiDMap);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!IDMappingOptions.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in IDMappingOptions is not found in the"
                                        + " empty JSON string",
                                IDMappingOptions.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `IDMappingOptions` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<IDMappingOptions>() {
                        @Override
                        public void write(JsonWriter out, IDMappingOptions value)
                                throws IOException {
