...
public class ImageBuildLibpod200Response implements Serializable {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImageBuildLibpod200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImageBuildLibpod200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImageBuildLibpod200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImageBuildLibpod200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
