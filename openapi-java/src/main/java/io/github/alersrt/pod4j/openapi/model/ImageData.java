...
public class ImageData {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ImageData.openapiRequiredFields
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ImageData is not found in the empty"
                                        + " JSON string",
        ...
        if (jsonObj.get("History") != null && !jsonObj.get("History").isJsonNull()) {
            ...
            if (jsonArrayhistory != null) {
                ...
                if (!jsonObj.get("History").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `History` to be an array in the JSON string"
                                            + " but got `%s`",
        ...
        if ((jsonObj.get("ManifestType") != null && !jsonObj.get("ManifestType").isJsonNull())
                && !jsonObj.get("ManifestType").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `ManifestType` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("ManifestType").toString()));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("NamesHistory") != null
                && !jsonObj.get("NamesHistory").isJsonNull()
                && !jsonObj.get("NamesHistory").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `NamesHistory` to be an array in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("NamesHistory").toString()));
        }
