...
public class ImageInspect {
    ...
    /**
     * Author is the name of the author that was specified when committing the image, or as
    ...
    /**
     * Created is the date and time at which the image was created, formatted in RFC 3339
     * nano-seconds (time.RFC3339Nano). This information is only available if present in the image,
    ...
    /**
     * DockerVersion is the version of Docker that was used to build the image. Depending on how the
     * image was created, this field may be empty.
     *
    ...
    /**
     * ID is the content-addressable ID of an image. This identifier is a content-addressable digest
     * calculated from the image&#39;s configuration (which includes the digests of layers used by
     * the image). Note that this digest differs from the &#x60;RepoDigests&#x60; below, which holds
    ...
    /**
     * OsVersion is the version of the Operating System the image is built to run on (especially for
     * Windows).
     *
     * @return osVersion
     */
    ...
    /**
     * Parent is the ID of the parent image. Depending on how the image was created, this field may
     * be empty and is only set for images that were built/created locally. This field is empty if
     * the image was pulled from an image registry.
     *
     * @return parent
     */
    @javax.annotation.Nullable
    ...
    /**
     * RepoDigests is a list of content-addressable digests of locally available image manifests
     * that the image is referenced from. Multiple manifests can refer to the same image. These
     * digests are usually only available if the image was either pulled from a registry, or if the
     * image was pushed to a registry, which is when the manifest is generated and its digest
     * calculated.
     *
     * @return repoDigests
     */
     ...
     * reference the image, in which case the image is \&quot;untagged\&quot;, in which case it can
     * still be referenced by its ID.
     *
     * @return repoTags
     */
    @javax.annotation.Nullable
     ...
     * Deprecated: this field is omitted in API v1.44, but kept for backward compatibility. Use Size
     * instead.
     *
     * @return virtualSize
     */
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ImageInspect.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ImageInspect is not found in the empty"
                                        + " JSON string",
                                ImageInspect.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ImageInspect` properties. JSON: %s",
        ...
        if ((jsonObj.get("Container") != null && !jsonObj.get("Container").isJsonNull())
            ...
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Container` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("Container").toString()));
        }
        // validate the optional field `ContainerConfig`
        if (jsonObj.get("ContainerConfig") != null
                && !jsonObj.get("ContainerConfig").isJsonNull()) {
        ...
        if ((jsonObj.get("Created") != null && !jsonObj.get("Created").isJsonNull())
            ...
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Created` to be a primitive type in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("Created").toString()));
        }
        if ((jsonObj.get("DockerVersion") != null && !jsonObj.get("DockerVersion").isJsonNull())
                && !jsonObj.get("DockerVersion").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `DockerVersion` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("DockerVersion").toString()));
        }
        ...
        if ((jsonObj.get("OsVersion") != null && !jsonObj.get("OsVersion").isJsonNull())
                && !jsonObj.get("OsVersion").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `OsVersion` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("OsVersion").toString()));
        }
        if ((jsonObj.get("Parent") != null && !jsonObj.get("Parent").isJsonNull())
                && !jsonObj.get("Parent").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Parent` to be a primitive type in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("Parent").toString()));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("RepoDigests") != null
                && !jsonObj.get("RepoDigests").isJsonNull()
                && !jsonObj.get("RepoDigests").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `RepoDigests` to be an array in the JSON string but"
                                    + " got `%s`",
                            jsonObj.get("RepoDigests").toString()));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("RepoTags") != null
                && !jsonObj.get("RepoTags").isJsonNull()
                && !jsonObj.get("RepoTags").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `RepoTags` to be an array in the JSON string but"
                                    + " got `%s`",
                            jsonObj.get("RepoTags").toString()));
        }
