...
public class ImagePropertiesSize {
  ...
  /**
   * Return true if this ImageProperties_Size object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `Unpacked` to the URL query string
    if (getUnpacked() != null) {
      joiner.add(String.format("%sUnpacked%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getUnpacked()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
