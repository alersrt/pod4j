...
public class ImagePropertiesSize {
    ...
    /**
     * Unpacked is the size (in bytes) of the locally unpacked (uncompressed) image content
     * that&#39;s directly usable by the containers running this image. It&#39;s independent of the
     * distributable content - e.g. the image might still have an unpacked data that&#39;s still
     * used by some container even when the distributable/compressed content is already gone.
     *
     * @return unpacked
     */
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ImagePropertiesSize.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ImagePropertiesSize is not found in"
                                        + " the empty JSON string",
                                ImagePropertiesSize.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ImagePropertiesSize` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ImagePropertiesSize>() {
                        @Override
                        public void write(JsonWriter out, ImagePropertiesSize value)
                                throws IOException {
