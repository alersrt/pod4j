...
/**
 * ImageVolume is a volume based on a container image. The container image is first mounted on the
 * host and is then bind-mounted into the container. An ImageVolume is always mounted read-only.
 */
...
public class ImageVolume {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ImageVolume.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ImageVolume is not found in the empty"
                                        + " JSON string",
                                ImageVolume.openapiRequiredFields.toString()));
            }
        }
