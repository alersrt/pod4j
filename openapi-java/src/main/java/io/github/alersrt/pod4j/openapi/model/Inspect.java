...
public class Inspect {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!Inspect.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Inspect is not found in the empty JSON"
                                        + " string",
                                Inspect.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!Inspect.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `Inspect`"
                                        + " properties. JSON: %s",
        ...
        if (jsonObj.get("Peers") != null && !jsonObj.get("Peers").isJsonNull()) {
            ...
            if (jsonArraypeers != null) {
                ...
                if (!jsonObj.get("Peers").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `Peers` to be an array in the JSON string"
                                            + " but got `%s`",
                                    jsonObj.get("Peers").toString()));
                }
