...
/**
 * InspectContainerData provides a detailed record of a container&#39;s configuration and state as
 * viewed by Libpod. Large portions of this structure are defined such that the output is compatible
 * with &#x60;docker inspect&#x60; JSON, but additional fields have been added as required to share
 * information not in the original output.
 */
...
public class InspectContainerData {
    ...
    public static final String SERIALIZED_NAME_KUBE_EXIT_CODE_PROPAGATION =
    ...
    private List<InspectMount> mounts = new ArrayList<>();
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.appArmorProfile, inspectContainerData.appArmorProfile)
                ...
                && Objects.equals(
                        this.kubeExitCodePropagation, inspectContainerData.kubeExitCodePropagation)
    ...
    public String toString() {
        ...
        sb.append("    kubeExitCodePropagation: ")
                .append(toIndentedString(kubeExitCodePropagation))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!InspectContainerData.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in InspectContainerData is not found in"
                                        + " the empty JSON string",
                                InspectContainerData.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `InspectContainerData` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        if ((jsonObj.get("AppArmorProfile") != null && !jsonObj.get("AppArmorProfile").isJsonNull())
                && !jsonObj.get("AppArmorProfile").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `AppArmorProfile` to be a primitive type in the"
                                    + " JSON string but got `%s`",
                            jsonObj.get("AppArmorProfile").toString()));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("Args") != null
                && !jsonObj.get("Args").isJsonNull()
                && !jsonObj.get("Args").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Args` to be an array in the JSON string but got"
                                    + " `%s`",
                            jsonObj.get("Args").toString()));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("BoundingCaps") != null
                && !jsonObj.get("BoundingCaps").isJsonNull()
                && !jsonObj.get("BoundingCaps").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `BoundingCaps` to be an array in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("BoundingCaps").toString()));
        }
        // validate the optional field `Config`
        if (jsonObj.get("Config") != null && !jsonObj.get("Config").isJsonNull()) {
            InspectContainerConfig.validateJsonElement(jsonObj.get("Config"));
        }
        if ((jsonObj.get("ConmonPidFile") != null && !jsonObj.get("ConmonPidFile").isJsonNull())
                && !jsonObj.get("ConmonPidFile").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `ConmonPidFile` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("ConmonPidFile").toString()));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("Dependencies") != null
                && !jsonObj.get("Dependencies").isJsonNull()
                && !jsonObj.get("Dependencies").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Dependencies` to be an array in the JSON string"
                                    + " but got `%s`",
        ...
        // ensure the optional json data is an array if present
        if (jsonObj.get("EffectiveCaps") != null
                && !jsonObj.get("EffectiveCaps").isJsonNull()
                && !jsonObj.get("EffectiveCaps").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `EffectiveCaps` to be an array in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("EffectiveCaps").toString()));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("ExecIDs") != null
                && !jsonObj.get("ExecIDs").isJsonNull()
                && !jsonObj.get("ExecIDs").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `ExecIDs` to be an array in the JSON string but got"
                                    + " `%s`",
                            jsonObj.get("ExecIDs").toString()));
        }
        ...
        if ((jsonObj.get("HostnamePath") != null && !jsonObj.get("HostnamePath").isJsonNull())
                && !jsonObj.get("HostnamePath").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `HostnamePath` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("HostnamePath").toString()));
        }
        if ((jsonObj.get("HostsPath") != null && !jsonObj.get("HostsPath").isJsonNull())
                && !jsonObj.get("HostsPath").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `HostsPath` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("HostsPath").toString()));
        }
        ...
        if ((jsonObj.get("ImageDigest") != null && !jsonObj.get("ImageDigest").isJsonNull())
                && !jsonObj.get("ImageDigest").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `ImageDigest` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("ImageDigest").toString()));
        }
        ...
        if ((jsonObj.get("KubeExitCodePropagation") != null
                        && !jsonObj.get("KubeExitCodePropagation").isJsonNull())
                && !jsonObj.get("KubeExitCodePropagation").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `KubeExitCodePropagation` to be a primitive type in"
                                    + " the JSON string but got `%s`",
                            jsonObj.get("KubeExitCodePropagation").toString()));
        }
        if ((jsonObj.get("MountLabel") != null && !jsonObj.get("MountLabel").isJsonNull())
                && !jsonObj.get("MountLabel").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `MountLabel` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("MountLabel").toString()));
        }
        ...
        if (jsonObj.get("NetworkSettings") != null
                && !jsonObj.get("NetworkSettings").isJsonNull()) {
            InspectNetworkSettings.validateJsonElement(jsonObj.get("NetworkSettings"));
        }
        if ((jsonObj.get("OCIConfigPath") != null && !jsonObj.get("OCIConfigPath").isJsonNull())
                && !jsonObj.get("OCIConfigPath").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `OCIConfigPath` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("OCIConfigPath").toString()));
        }
        if ((jsonObj.get("OCIRuntime") != null && !jsonObj.get("OCIRuntime").isJsonNull())
                && !jsonObj.get("OCIRuntime").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `OCIRuntime` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("OCIRuntime").toString()));
        }
        ...
        if ((jsonObj.get("PidFile") != null && !jsonObj.get("PidFile").isJsonNull())
                && !jsonObj.get("PidFile").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `PidFile` to be a primitive type in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("PidFile").toString()));
        }
        ...
        if ((jsonObj.get("ProcessLabel") != null && !jsonObj.get("ProcessLabel").isJsonNull())
                && !jsonObj.get("ProcessLabel").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `ProcessLabel` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("ProcessLabel").toString()));
        }
        if ((jsonObj.get("ResolvConfPath") != null && !jsonObj.get("ResolvConfPath").isJsonNull())
                && !jsonObj.get("ResolvConfPath").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `ResolvConfPath` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("ResolvConfPath").toString()));
        }
        ...
        if ((jsonObj.get("StaticDir") != null && !jsonObj.get("StaticDir").isJsonNull())
                && !jsonObj.get("StaticDir").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `StaticDir` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("StaticDir").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<InspectContainerData>() {
                        @Override
                        public void write(JsonWriter out, InspectContainerData value)
                                throws IOException {
