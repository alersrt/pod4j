...
public class InspectExecSession {
    ...
    /**
     * CanRemove is legacy and used purely for compatibility reasons. Will always be set to true,
     * unless the exec session is running.
     *
     * @return canRemove
     */
    ...
    /**
     * DetachKeys are the detach keys used by the exec session. If set to \&quot;\&quot; the default
     * keys are being used. Will show \&quot;&lt;none&gt;\&quot; if no detach keys are set.
     *
     * @return detachKeys
     */
    @javax.annotation.Nullable
    ...
    /**
     * ExitCode is the exit code of the exec session. Will be set to 0 if the exec session has not
     * yet exited.
     *
     * @return exitCode
     */
    ...
    /**
     * OpenStderr is whether the container&#39;s STDERR stream will be attached. Always set to true
     * if the exec session created a TTY.
     *
     * @return openStderr
     */
    @javax.annotation.Nullable
    ...
    /**
     * OpenStdout is whether the container&#39;s STDOUT stream will be attached. Always set to true
     * if the exec session created a TTY.
     *
     * @return openStdout
     */
    ...
    /**
     * Pid is the PID of the exec session&#39;s process. Will be set to 0 if the exec session is not
     * running.
     *
     * @return pid
     */
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!InspectExecSession.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in InspectExecSession is not found in the"
                                        + " empty JSON string",
                                InspectExecSession.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `InspectExecSession` properties. JSON: %s",
        ...
        if ((jsonObj.get("DetachKeys") != null && !jsonObj.get("DetachKeys").isJsonNull())
                && !jsonObj.get("DetachKeys").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `DetachKeys` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("DetachKeys").toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<InspectExecSession>() {
                        @Override
                        public void write(JsonWriter out, InspectExecSession value)
                                throws IOException {
