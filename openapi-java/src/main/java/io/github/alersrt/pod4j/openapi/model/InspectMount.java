...
/**
 * InspectMount provides a record of a single mount in a container. It contains fields for both
 * named and normal volumes. Only user-specified volumes will be included, and tmpfs volumes are not
 * included even if the user specified them.
 */
...
public class InspectMount {
    ...
    /**
     * The destination directory for the volume. Specified as a path within the container, as it
     * would be passed into the OCI runtime.
     *
     * @return destination
     */
    ...
    /**
     * Mount propagation for the mount. Can be empty if not specified, but is always printed - no
     * omitempty.
     *
     * @return propagation
     */
    ...
    /**
     * Whether the mount is a volume or bind mount. Allowed values are \&quot;volume\&quot; and
     * \&quot;bind\&quot;.
     *
     * @return type
     */
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!InspectMount.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in InspectMount is not found in the empty"
                                        + " JSON string",
                                InspectMount.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `InspectMount` properties. JSON: %s",
        ...
        if ((jsonObj.get("Mode") != null && !jsonObj.get("Mode").isJsonNull())
            ...
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Mode` to be a primitive type in the JSON string"
                                    + " but got `%s`",
