...
/**
 * InspectPodData contains detailed information on a pod&#39;s configuration and state. It is used
 * as the output of Inspect on pods.
 */
...
public class InspectPodData {
    ...
    private List<InspectPodContainerInfo> containers = new ArrayList<>();
    ...
    private List<InspectBlkioThrottleDevice> deviceReadBps = new ArrayList<>();
    ...
    private List<InspectBlkioThrottleDevice> deviceWriteBps = new ArrayList<>();
    ...
    /**
     * CreateCommand is the full command plus arguments of the process the container has been
     * created with.
     *
    ...
    /**
     * SharedNamespaces contains a list of namespaces that will be shared by containers within the
     * pod. Can only be set if CreateInfra is true.
     *
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!InspectPodData.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in InspectPodData is not found in the"
                                        + " empty JSON string",
                                InspectPodData.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `InspectPodData` properties. JSON: %s",
        ...
        if ((jsonObj.get("CgroupPath") != null && !jsonObj.get("CgroupPath").isJsonNull())
                && !jsonObj.get("CgroupPath").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `CgroupPath` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("CgroupPath").toString()));
        }
        ...
        if (jsonObj.get("CreateCommand") != null
                && !jsonObj.get("CreateCommand").isJsonNull()
                && !jsonObj.get("CreateCommand").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `CreateCommand` to be an array in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("CreateCommand").toString()));
        }
        if ((jsonObj.get("ExitPolicy") != null && !jsonObj.get("ExitPolicy").isJsonNull())
                && !jsonObj.get("ExitPolicy").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `ExitPolicy` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("ExitPolicy").toString()));
        }
        ...
        if ((jsonObj.get("InfraContainerID") != null
                        && !jsonObj.get("InfraContainerID").isJsonNull())
                && !jsonObj.get("InfraContainerID").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `InfraContainerID` to be a primitive type in the"
                                    + " JSON string but got `%s`",
                            jsonObj.get("InfraContainerID").toString()));
        }
        ...
        if ((jsonObj.get("RestartPolicy") != null && !jsonObj.get("RestartPolicy").isJsonNull())
                && !jsonObj.get("RestartPolicy").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `RestartPolicy` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("RestartPolicy").toString()));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("SharedNamespaces") != null
                && !jsonObj.get("SharedNamespaces").isJsonNull()
                && !jsonObj.get("SharedNamespaces").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `SharedNamespaces` to be an array in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("SharedNamespaces").toString()));
        }
        ...
        if (jsonObj.get("blkio_weight_device") != null
                && !jsonObj.get("blkio_weight_device").isJsonNull()) {
            ...
            if (jsonArrayblkioWeightDevice != null) {
                ...
                if (!jsonObj.get("blkio_weight_device").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `blkio_weight_device` to be an array in the"
                                            + " JSON string but got `%s`",
                                    jsonObj.get("blkio_weight_device").toString()));
                }
        ...
        if ((jsonObj.get("cpuset_mems") != null && !jsonObj.get("cpuset_mems").isJsonNull())
                && !jsonObj.get("cpuset_mems").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `cpuset_mems` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("cpuset_mems").toString()));
        }
        if (jsonObj.get("device_read_bps") != null
            ...
            if (jsonArraydeviceReadBps != null) {
                ...
                if (!jsonObj.get("device_read_bps").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `device_read_bps` to be an array in the"
                                            + " JSON string but got `%s`",
        ...
        if (jsonObj.get("device_write_bps") != null
                && !jsonObj.get("device_write_bps").isJsonNull()) {
            ...
            if (jsonArraydeviceWriteBps != null) {
                ...
                if (!jsonObj.get("device_write_bps").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `device_write_bps` to be an array in the"
                                            + " JSON string but got `%s`",
                                    jsonObj.get("device_write_bps").toString()));
                }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<InspectPodData>() {
                        @Override
