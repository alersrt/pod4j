...
public class InspectRestartPolicy {
    ...
    /**
     * MaximumRetryCount is the maximum number of retries allowed if the \&quot;on-failure\&quot;
     * restart policy is in use. Not used if \&quot;on-failure\&quot; is not set.
     *
    ...
    /**
     * Name contains the container&#39;s restart policy. Allowable values are \&quot;no\&quot; or
     * \&quot;\&quot; (take no action), \&quot;on-failure\&quot; (restart on non-zero exit code,
     * with an optional max retry count), and \&quot;always\&quot; (always restart on container
     * stop, unless explicitly requested by API). Note that this is NOT actually a name of any sort
     * - the poor naming is for Docker compatibility.
     *
     * @return name
     */
    @javax.annotation.Nullable
    ...
    public String toString() {
        ...
        sb.append("    maximumRetryCount: ")
                .append(toIndentedString(maximumRetryCount))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!InspectRestartPolicy.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in InspectRestartPolicy is not found in"
                                        + " the empty JSON string",
                                InspectRestartPolicy.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `InspectRestartPolicy` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<InspectRestartPolicy>() {
                        @Override
                        public void write(JsonWriter out, InspectRestartPolicy value)
                                throws IOException {
