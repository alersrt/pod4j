 ...
 */
@JsonPropertyOrder({
  InspectUlimit.JSON_PROPERTY_HARD,
  InspectUlimit.JSON_PROPERTY_NAME,
  InspectUlimit.JSON_PROPERTY_SOFT
})
...
public class InspectUlimit {
  ...
  /**
   * Return true if this InspectUlimit object is equal to o.
   */
  @Override
