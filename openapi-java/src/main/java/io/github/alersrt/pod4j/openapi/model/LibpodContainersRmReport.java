...
public class LibpodContainersRmReport {
    ...
    /**
     * Error which occurred during Rm operation (if any). This field is optional and may be omitted
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!LibpodContainersRmReport.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in LibpodContainersRmReport is not found"
                                        + " in the empty JSON string",
                                LibpodContainersRmReport.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `LibpodContainersRmReport` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!LibpodContainersRmReport.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'LibpodContainersRmReport' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<LibpodContainersRmReport>() {
                        @Override
                        public void write(JsonWriter out, LibpodContainersRmReport value)
                                throws IOException {
