...
public class LinuxHugepageLimit {
    ...
    /**
     * Limit is the limit of \&quot;hugepagesize\&quot; hugetlb reservations (if supported) or
     * usage.
     *
     * @return limit
     */
    ...
    /**
     * Pagesize is the hugepage size. Format: \&quot;&lt;size&gt;&lt;unit-prefix&gt;B&#39; (e.g.
     * 64KB, 2MB, 1GB, etc.).
     *
     * @return pageSize
     */
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!LinuxHugepageLimit.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in LinuxHugepageLimit is not found in the"
                                        + " empty JSON string",
                                LinuxHugepageLimit.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `LinuxHugepageLimit` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        if ((jsonObj.get("pageSize") != null && !jsonObj.get("pageSize").isJsonNull())
                && !jsonObj.get("pageSize").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `pageSize` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("pageSize").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<LinuxHugepageLimit>() {
                        @Override
                        public void write(JsonWriter out, LinuxHugepageLimit value)
                                throws IOException {
