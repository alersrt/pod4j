...
public class LinuxMemory {
    ...
    /**
     * CheckBeforeUpdate enables checking if a new memory limit is lower than the current usage
     * during update, and if so, rejecting the new limit.
     *
    ...
    /**
     * Kernel memory limit (in bytes). Deprecated: kernel-memory limits are not supported in cgroups
     * v2, and were obsoleted in [kernel v5.4]. This field should no longer be used, as it may be
     * ignored by runtimes. [kernel v5.4]:
     * https://github.com/torvalds/linux/commit/0158115f702b0ba208ab0
     *
     * @return kernel
     */
    @javax.annotation.Nullable
    ...
    public String toString() {
        ...
        sb.append("    checkBeforeUpdate: ")
                .append(toIndentedString(checkBeforeUpdate))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!LinuxMemory.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in LinuxMemory is not found in the empty"
                                        + " JSON string",
                                LinuxMemory.openapiRequiredFields.toString()));
            }
        }
