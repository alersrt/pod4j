...
public class LinuxNetwork {
    ...
    private List<LinuxInterfacePriority> priorities = new ArrayList<>();
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!LinuxNetwork.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in LinuxNetwork is not found in the empty"
                                        + " JSON string",
                                LinuxNetwork.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `LinuxNetwork` properties. JSON: %s",
        ...
        if (jsonObj.get("priorities") != null && !jsonObj.get("priorities").isJsonNull()) {
            ...
            if (jsonArraypriorities != null) {
                ...
                if (!jsonObj.get("priorities").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `priorities` to be an array in the JSON"
                                            + " string but got `%s`",
                                    jsonObj.get("priorities").toString()));
                }
