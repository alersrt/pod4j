...
public class ListContainer {
    ...
    /**
     * ExposedPorts contains the ports that are exposed but not forwarded, see Ports for forwarded
     * ports. The key is the port number and the string slice contains the protocols, i.e.
     * \&quot;tcp\&quot;, \&quot;udp\&quot; and \&quot;sctp\&quot;.
     *
     * @return exposedPorts
     */
    ...
    /**
     * Restarts is how many times the container was restarted by its restart policy. This is NOT
     * incremented by normal container restarts (only by restart policy).
     *
     * @return restarts
     */
    @javax.annotation.Nullable
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ListContainer.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ListContainer is not found in the"
                                        + " empty JSON string",
                                ListContainer.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ListContainer` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        if ((jsonObj.get("CIDFile") != null && !jsonObj.get("CIDFile").isJsonNull())
                && !jsonObj.get("CIDFile").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `CIDFile` to be a primitive type in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("CIDFile").toString()));
        }
        ...
        if ((jsonObj.get("ImageID") != null && !jsonObj.get("ImageID").isJsonNull())
            ...
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `ImageID` to be a primitive type in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("ImageID").toString()));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("Mounts") != null
                && !jsonObj.get("Mounts").isJsonNull()
                && !jsonObj.get("Mounts").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Mounts` to be an array in the JSON string but got"
                                    + " `%s`",
                            jsonObj.get("Mounts").toString()));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("Names") != null
                && !jsonObj.get("Names").isJsonNull()
                && !jsonObj.get("Names").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
        ...
        if ((jsonObj.get("PodName") != null && !jsonObj.get("PodName").isJsonNull())
                && !jsonObj.get("PodName").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `PodName` to be a primitive type in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("PodName").toString()));
        }
        if (jsonObj.get("Ports") != null && !jsonObj.get("Ports").isJsonNull()) {
            ...
            if (jsonArrayports != null) {
                ...
                if (!jsonObj.get("Ports").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `Ports` to be an array in the JSON string"
                                            + " but got `%s`",
                                    jsonObj.get("Ports").toString()));
                }
