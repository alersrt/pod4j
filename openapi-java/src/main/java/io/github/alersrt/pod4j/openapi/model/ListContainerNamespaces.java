...
public class ListContainerNamespaces {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ListContainerNamespaces.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ListContainerNamespaces is not found"
                                        + " in the empty JSON string",
                                ListContainerNamespaces.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ListContainerNamespaces` properties. JSON: %s",
        ...
        if ((jsonObj.get("Mnt") != null && !jsonObj.get("Mnt").isJsonNull())
                && !jsonObj.get("Mnt").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Mnt` to be a primitive type in the JSON string but"
                                    + " got `%s`",
                            jsonObj.get("Mnt").toString()));
        }
        if ((jsonObj.get("Net") != null && !jsonObj.get("Net").isJsonNull())
                && !jsonObj.get("Net").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Net` to be a primitive type in the JSON string but"
                                    + " got `%s`",
                            jsonObj.get("Net").toString()));
        }
        if ((jsonObj.get("Pidns") != null && !jsonObj.get("Pidns").isJsonNull())
                && !jsonObj.get("Pidns").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Pidns` to be a primitive type in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("Pidns").toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ListContainerNamespaces.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ListContainerNamespaces' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ListContainerNamespaces>() {
                        @Override
                        public void write(JsonWriter out, ListContainerNamespaces value)
                                throws IOException {
