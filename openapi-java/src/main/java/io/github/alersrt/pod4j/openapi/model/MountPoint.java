...
public class MountPoint {
    ...
    /**
     * Destination is the path relative to the container root (&#x60;/&#x60;) where the Source is
     ...
     * mount. The default is platform-specific (&#x60;\&quot;z\&quot;&#x60; on Linux, empty on
     * Windows).
     *
     * @return mode
     */
    ...
    /**
     * Source is the source location of the mount. For volumes, this contains the storage location
     * of the volume (within &#x60;/var/lib/docker/volumes/&#x60;). For bind-mounts, and
     * &#x60;npipe&#x60;, this contains the source (host) part of the bind-mount. For
     * &#x60;tmpfs&#x60; mount points, this field is empty.
     *
     * @return source
     */
    @javax.annotation.Nullable
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!MountPoint.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in MountPoint is not found in the empty"
                                        + " JSON string",
                                MountPoint.openapiRequiredFields.toString()));
            }
        }
