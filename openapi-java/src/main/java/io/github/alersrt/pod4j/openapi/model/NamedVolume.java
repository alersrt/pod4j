...
public class NamedVolume {
    ...
    /**
     * Destination to mount the named volume within the container. Must be an absolute path. Path
    ...
    /**
     * IsAnonymous sets the named volume as anonymous even if it has a name This is used for
     * emptyDir volumes from a kube yaml
     *
     * @return isAnonymous
     */
    @javax.annotation.Nullable
    ...
    /**
     * Name is the name of the named volume to be mounted. May be empty. If empty, a new named
     * volume with a pseudorandomly generated name will be mounted at the given destination.
     *
     * @return name
     */
    @javax.annotation.Nullable
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!NamedVolume.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in NamedVolume is not found in the empty"
                                        + " JSON string",
                                NamedVolume.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `NamedVolume` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        if ((jsonObj.get("Dest") != null && !jsonObj.get("Dest").isJsonNull())
                && !jsonObj.get("Dest").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Dest` to be a primitive type in the JSON string"
                                    + " but got `%s`",
