...
public class Namespace {
    public static final String SERIALIZED_NAME_NSMODE = "nsmode";
    ...
    @SerializedName(SERIALIZED_NAME_NSMODE)
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!Namespace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format("The required field(s) %s in Namespace is not found in the empty JSON string", Namespace.openapiRequiredFields));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!Namespace.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Namespace` properties. JSON: %s", entry.getKey(), jsonElement));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        if ((jsonObj.get("nsmode") != null && !jsonObj.get("nsmode").isJsonNull()) && !jsonObj.get("nsmode").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `nsmode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nsmode").toString()));
        }
    ...
    public Namespace nsmode(String nsmode) {
        this.nsmode = nsmode;
        return this;
    }
    ...
    public Namespace value(String value) {
        this.value = value;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.nsmode, namespace.nsmode) &&
                Objects.equals(this.value, namespace.value);
    }

    @Override
    public int hashCode() {
        return Objects.hash(nsmode, value);
    }

    @Override
    public String toString() {
        String sb = "class Namespace {\n" +
                "    nsmode: " + toIndentedString(nsmode) + "\n" +
