...
public class Namespace {
    ...
    public String toString() {
        ...
        sb.append("    nsmode: ").append(toIndentedString(nsmode)).append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!Namespace.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Namespace is not found in the empty"
                                        + " JSON string",
                                Namespace.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `Namespace` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        if ((jsonObj.get("nsmode") != null && !jsonObj.get("nsmode").isJsonNull())
                && !jsonObj.get("nsmode").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `nsmode` to be a primitive type in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("nsmode").toString()));
        }
