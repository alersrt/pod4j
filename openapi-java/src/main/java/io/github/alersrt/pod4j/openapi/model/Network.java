 ...
 */
@JsonPropertyOrder({
  Network.JSON_PROPERTY_CREATED,
  Network.JSON_PROPERTY_DNS_ENABLED,
  Network.JSON_PROPERTY_DRIVER,
  Network.JSON_PROPERTY_ID,
  Network.JSON_PROPERTY_INTERNAL,
  Network.JSON_PROPERTY_IPAM_OPTIONS,
  Network.JSON_PROPERTY_IPV6_ENABLED,
  Network.JSON_PROPERTY_LABELS,
  Network.JSON_PROPERTY_NAME,
  Network.JSON_PROPERTY_NETWORK_DNS_SERVERS,
  Network.JSON_PROPERTY_NETWORK_INTERFACE,
  Network.JSON_PROPERTY_OPTIONS,
  Network.JSON_PROPERTY_ROUTES,
  Network.JSON_PROPERTY_SUBNETS
})
