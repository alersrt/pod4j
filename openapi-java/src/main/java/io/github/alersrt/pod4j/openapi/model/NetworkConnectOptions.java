...
public class NetworkConnectOptions {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!NetworkConnectOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkConnectOptions is not found in the empty JSON string", NetworkConnectOptions.openapiRequiredFields));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!NetworkConnectOptions.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NetworkConnectOptions` properties. JSON: %s", entry.getKey(), jsonElement));
            }
        }
    ...
    public String toString() {
        String sb = "class NetworkConnectOptions {\n" +
                "    aliases: " + toIndentedString(aliases) + "\n" +
                "    container: " + toIndentedString(container) + "\n" +
                "    interfaceName: " + toIndentedString(interfaceName) + "\n" +
                "    staticIps: " + toIndentedString(staticIps) + "\n" +
                "    staticMac: " + toIndentedString(staticMac) + "\n" +
                "}";
        return sb;
    }
