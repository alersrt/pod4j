...
public class NetworkCreateLibpod {
     ...
     * @throws IOException if the JSON Element is invalid with respect to NetworkCreateLibpod
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!NetworkCreateLibpod.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkCreateLibpod is not found in the empty JSON string", NetworkCreateLibpod.openapiRequiredFields));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!NetworkCreateLibpod.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NetworkCreateLibpod` properties. JSON: %s", entry.getKey(), jsonElement));
            }
        }
    ...
    /**
     * Create an instance of NetworkCreateLibpod given an JSON string
     *
    ...
    public String toString() {
        String sb = "class NetworkCreateLibpod {\n" +
                "    created: " + toIndentedString(created) + "\n" +
                "    dnsEnabled: " + toIndentedString(dnsEnabled) + "\n" +
                "    driver: " + toIndentedString(driver) + "\n" +
                "    id: " + toIndentedString(id) + "\n" +
                "    internal: " + toIndentedString(internal) + "\n" +
                "    ipamOptions: " + toIndentedString(ipamOptions) + "\n" +
                "    ipv6Enabled: " + toIndentedString(ipv6Enabled) + "\n" +
                "    labels: " + toIndentedString(labels) + "\n" +
                "    name: " + toIndentedString(name) + "\n" +
                "    networkDnsServers: " + toIndentedString(networkDnsServers) + "\n" +
                "    networkInterface: " + toIndentedString(networkInterface) + "\n" +
                "    options: " + toIndentedString(options) + "\n" +
                "    routes: " + toIndentedString(routes) + "\n" +
                "    subnets: " + toIndentedString(subnets) + "\n" +
                "}";
        return sb;
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!NetworkCreateLibpod.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'NetworkCreateLibpod' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<NetworkCreateLibpod> thisAdapter
                    = gson.getDelegateAdapter(this, TypeToken.get(NetworkCreateLibpod.class));

            return (TypeAdapter<T>) new TypeAdapter<NetworkCreateLibpod>() {
                @Override
                public void write(JsonWriter out, NetworkCreateLibpod value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public NetworkCreateLibpod read(JsonReader in) throws IOException {
