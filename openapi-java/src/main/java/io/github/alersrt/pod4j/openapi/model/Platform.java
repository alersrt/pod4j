...
public class Platform {
    ...
    /**
     * Architecture field specifies the CPU architecture, for example &#x60;amd64&#x60; or
     * &#x60;ppc64le&#x60;.
     *
     * @return architecture
     */
    ...
    /**
     * OSVersion is an optional field specifying the operating system version, for example on
    ...
    /**
     * Variant is an optional field specifying a variant of the CPU, for example &#x60;v7&#x60; to
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!Platform.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Platform is not found in the empty"
                                        + " JSON string",
                                Platform.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!Platform.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `Platform`"
                                        + " properties. JSON: %s",
