...
public class PlayKubePod {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PlayKubePod.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in PlayKubePod is not found in the empty"
                                        + " JSON string",
                                PlayKubePod.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `PlayKubePod` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        // ensure the optional json data is an array if present
        if (jsonObj.get("ContainerErrors") != null
                && !jsonObj.get("ContainerErrors").isJsonNull()
                && !jsonObj.get("ContainerErrors").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `ContainerErrors` to be an array in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("ContainerErrors").toString()));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("Containers") != null
                && !jsonObj.get("Containers").isJsonNull()
                && !jsonObj.get("Containers").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Containers` to be an array in the JSON string but"
                                    + " got `%s`",
        ...
        // ensure the optional json data is an array if present
        if (jsonObj.get("InitContainers") != null
                && !jsonObj.get("InitContainers").isJsonNull()
                && !jsonObj.get("InitContainers").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `InitContainers` to be an array in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("InitContainers").toString()));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("Logs") != null
                && !jsonObj.get("Logs").isJsonNull()
                && !jsonObj.get("Logs").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Logs` to be an array in the JSON string but got"
                                    + " `%s`",
