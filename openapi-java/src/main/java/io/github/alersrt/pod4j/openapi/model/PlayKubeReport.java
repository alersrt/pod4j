...
public class PlayKubeReport {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PlayKubeReport.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in PlayKubeReport is not found in the"
                                        + " empty JSON string",
                                PlayKubeReport.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `PlayKubeReport` properties. JSON: %s",
        ...
        if (jsonObj.get("Pods") != null && !jsonObj.get("Pods").isJsonNull()) {
            ...
            if (jsonArraypods != null) {
                ...
                if (!jsonObj.get("Pods").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `Pods` to be an array in the JSON string"
                                            + " but got `%s`",
                                    jsonObj.get("Pods").toString()));
                }
        ...
        if (jsonObj.get("RmReport") != null && !jsonObj.get("RmReport").isJsonNull()) {
            ...
            if (jsonArrayrmReport != null) {
                ...
                if (!jsonObj.get("RmReport").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `RmReport` to be an array in the JSON"
                                            + " string but got `%s`",
                                    jsonObj.get("RmReport").toString()));
                }
        ...
        if (jsonObj.get("SecretRmReport") != null && !jsonObj.get("SecretRmReport").isJsonNull()) {
            ...
            if (jsonArraysecretRmReport != null) {
                ...
                if (!jsonObj.get("SecretRmReport").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `SecretRmReport` to be an array in the JSON"
                                            + " string but got `%s`",
                                    jsonObj.get("SecretRmReport").toString()));
                }
        ...
        if (jsonObj.get("StopReport") != null && !jsonObj.get("StopReport").isJsonNull()) {
            ...
            if (jsonArraystopReport != null) {
                ...
                if (!jsonObj.get("StopReport").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `StopReport` to be an array in the JSON"
                                            + " string but got `%s`",
                                    jsonObj.get("StopReport").toString()));
                }
        ...
        if (jsonObj.get("VolumeRmReport") != null && !jsonObj.get("VolumeRmReport").isJsonNull()) {
            ...
            if (jsonArrayvolumeRmReport != null) {
                ...
                if (!jsonObj.get("VolumeRmReport").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `VolumeRmReport` to be an array in the JSON"
                                            + " string but got `%s`",
                                    jsonObj.get("VolumeRmReport").toString()));
                }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<PlayKubeReport>() {
                        @Override
