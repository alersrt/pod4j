...
public class PluginInterfaceType {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PluginInterfaceType.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in PluginInterfaceType is not found in"
                                        + " the empty JSON string",
                                PluginInterfaceType.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `PluginInterfaceType` properties. JSON: %s",
        ...
        if (!jsonObj.get("Capability").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Capability` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("Capability").toString()));
        }
        if (!jsonObj.get("Prefix").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Prefix` to be a primitive type in the JSON string"
                                    + " but got `%s`",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<PluginInterfaceType>() {
                        @Override
                        public void write(JsonWriter out, PluginInterfaceType value)
                                throws IOException {
