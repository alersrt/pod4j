...
public class PodStopReport {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PodStopReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format("The required field(s) %s in PodStopReport is not found in the empty JSON string", PodStopReport.openapiRequiredFields));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!PodStopReport.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PodStopReport` properties. JSON: %s", entry.getKey(), jsonElement));
            }
        }
    ...
    public String toString() {
        String sb = "class PodStopReport {\n" +
                "    errs: " + toIndentedString(errs) + "\n" +
                "    id: " + toIndentedString(id) + "\n" +
                "    rawInput: " + toIndentedString(rawInput) + "\n" +
                "}";
        return sb;
    }
