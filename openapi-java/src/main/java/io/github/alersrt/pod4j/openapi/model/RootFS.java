...
public class RootFS {
  ...
  /**
   * Return true if this RootFS object is equal to o.
   */
  @Override
    ...
    if (getLayers() != null) {
      for (int i = 0; i < getLayers().size(); i++) {
        joiner.add(String.format("%sLayers%s%s=%s", prefix, suffix,
            ...
            URLEncoder.encode(ApiClient.valueToString(getLayers().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }
