...
public class Schema2ListPublic {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!Schema2ListPublic.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format("The required field(s) %s in Schema2ListPublic is not found in the empty JSON string", Schema2ListPublic.openapiRequiredFields));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!Schema2ListPublic.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Schema2ListPublic` properties. JSON: %s", entry.getKey(), jsonElement));
            }
        }
    ...
    public String toString() {
        String sb = "class Schema2ListPublic {\n" +
                "    manifests: " + toIndentedString(manifests) + "\n" +
                "    mediaType: " + toIndentedString(mediaType) + "\n" +
                "    schemaVersion: " + toIndentedString(schemaVersion) + "\n" +
                "}";
        return sb;
    }
