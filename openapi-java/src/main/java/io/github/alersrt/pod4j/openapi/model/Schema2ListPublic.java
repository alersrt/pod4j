...
/**
 * This is publicly visible as c/image/manifest.Schema2List. Internal users should usually use
 * Schema2List instead.
 */
...
public class Schema2ListPublic {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!Schema2ListPublic.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Schema2ListPublic is not found in the"
                                        + " empty JSON string",
                                Schema2ListPublic.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `Schema2ListPublic` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<Schema2ListPublic>() {
                        @Override
                        public void write(JsonWriter out, Schema2ListPublic value)
                                throws IOException {
