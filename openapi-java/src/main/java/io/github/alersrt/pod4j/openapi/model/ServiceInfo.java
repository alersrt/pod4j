...
public class ServiceInfo {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ServiceInfo.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ServiceInfo is not found in the empty"
                                        + " JSON string",
                                ServiceInfo.openapiRequiredFields.toString()));
            }
        }
        ...
        if (jsonObj.get("Ports") != null
                && !jsonObj.get("Ports").isJsonNull()
                && !jsonObj.get("Ports").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Ports` to be an array in the JSON string but got"
                                    + " `%s`",
        ...
        if (jsonObj.get("Tasks") != null && !jsonObj.get("Tasks").isJsonNull()) {
            ...
            if (jsonArraytasks != null) {
                ...
                if (!jsonObj.get("Tasks").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `Tasks` to be an array in the JSON string"
                                            + " but got `%s`",
        ...
        if ((jsonObj.get("VIP") != null && !jsonObj.get("VIP").isJsonNull())
                && !jsonObj.get("VIP").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `VIP` to be a primitive type in the JSON string but"
                                    + " got `%s`",
                            jsonObj.get("VIP").toString()));
        }
    }
