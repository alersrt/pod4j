...
public class StartupHealthCheck {
    ...
    /**
     * Successes are the number of successes required to mark the startup HC as passed. If set to 0,
     * a single success will mark the HC as passed.
     *
     * @return successes
     */
    @javax.annotation.Nullable
    ...
    /**
     * Test is the test to perform to check that the container is healthy. An empty slice means to
     * inherit the default. The options are: {} : inherit healthcheck {\&quot;NONE\&quot;} : disable
     * healthcheck {\&quot;CMD\&quot;, args...} : exec arguments directly {\&quot;CMD-SHELL\&quot;,
     * command} : run command with system&#39;s default shell
     *
     * @return test
     */
    @javax.annotation.Nullable
    ...
    public int hashCode() {
        return Objects.hash(
                interval, retries, startInterval, startPeriod, successes, test, timeout);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!StartupHealthCheck.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in StartupHealthCheck is not found in the"
                                        + " empty JSON string",
                                StartupHealthCheck.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `StartupHealthCheck` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        // ensure the optional json data is an array if present
        if (jsonObj.get("Test") != null
                && !jsonObj.get("Test").isJsonNull()
                && !jsonObj.get("Test").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Test` to be an array in the JSON string but got"
                                    + " `%s`",
                            jsonObj.get("Test").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<StartupHealthCheck>() {
                        @Override
                        public void write(JsonWriter out, StartupHealthCheck value)
                                throws IOException {
