...
public class SystemDfContainerReport {
    ...
    public int hashCode() {
        return Objects.hash(
                command, containerID, created, image, localVolumes, names, rwSize, size, status);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SystemDfContainerReport.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SystemDfContainerReport is not found"
                                        + " in the empty JSON string",
                                SystemDfContainerReport.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `SystemDfContainerReport` properties. JSON: %s",
        ...
        if ((jsonObj.get("Names") != null && !jsonObj.get("Names").isJsonNull())
                && !jsonObj.get("Names").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `Names` to be a primitive type in the JSON string"
                                    + " but got `%s`",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SystemDfContainerReport.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SystemDfContainerReport' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<SystemDfContainerReport>() {
                        @Override
                        public void write(JsonWriter out, SystemDfContainerReport value)
                                throws IOException {
