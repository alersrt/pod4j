...
public class SystemPruneReport {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SystemPruneReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format("The required field(s) %s in SystemPruneReport is not found in the empty JSON string", SystemPruneReport.openapiRequiredFields));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!SystemPruneReport.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SystemPruneReport` properties. JSON: %s", entry.getKey(), jsonElement));
            }
        }
    ...
    public String toString() {
        String sb = "class SystemPruneReport {\n" +
                "    containerPruneReports: " + toIndentedString(containerPruneReports) + "\n" +
                "    imagePruneReports: " + toIndentedString(imagePruneReports) + "\n" +
                "    networkPruneReports: " + toIndentedString(networkPruneReports) + "\n" +
                "    podPruneReport: " + toIndentedString(podPruneReport) + "\n" +
                "    reclaimedSpace: " + toIndentedString(reclaimedSpace) + "\n" +
                "    volumePruneReports: " + toIndentedString(volumePruneReports) + "\n" +
                "}";
        return sb;
    }
