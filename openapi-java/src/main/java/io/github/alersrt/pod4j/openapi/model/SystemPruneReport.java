...
public class SystemPruneReport {
    ...
    public SystemPruneReport addNetworkPruneReportsItem(
            NetworkPruneReport networkPruneReportsItem) {
    ...
    public String toString() {
        ...
        sb.append("    containerPruneReports: ")
                .append(toIndentedString(containerPruneReports))
                .append("\n");
        sb.append("    imagePruneReports: ")
                .append(toIndentedString(imagePruneReports))
                .append("\n");
        sb.append("    networkPruneReports: ")
                .append(toIndentedString(networkPruneReports))
                .append("\n");
        ...
        sb.append("    volumePruneReports: ")
                .append(toIndentedString(volumePruneReports))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SystemPruneReport.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SystemPruneReport is not found in the"
                                        + " empty JSON string",
                                SystemPruneReport.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `SystemPruneReport` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        if (jsonObj.get("ContainerPruneReports") != null
                && !jsonObj.get("ContainerPruneReports").isJsonNull()) {
            JsonArray jsonArraycontainerPruneReports =
                    jsonObj.getAsJsonArray("ContainerPruneReports");
            if (jsonArraycontainerPruneReports != null) {
                // ensure the json data is an array
                if (!jsonObj.get("ContainerPruneReports").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `ContainerPruneReports` to be an array in"
                                            + " the JSON string but got `%s`",
                                    jsonObj.get("ContainerPruneReports").toString()));
                }
        ...
        if (jsonObj.get("ImagePruneReports") != null
                && !jsonObj.get("ImagePruneReports").isJsonNull()) {
            ...
            if (jsonArrayimagePruneReports != null) {
                ...
                if (!jsonObj.get("ImagePruneReports").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `ImagePruneReports` to be an array in the"
                                            + " JSON string but got `%s`",
                                    jsonObj.get("ImagePruneReports").toString()));
                }
        ...
        if (jsonObj.get("NetworkPruneReports") != null
                && !jsonObj.get("NetworkPruneReports").isJsonNull()) {
            ...
            if (jsonArraynetworkPruneReports != null) {
                ...
                if (!jsonObj.get("NetworkPruneReports").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `NetworkPruneReports` to be an array in the"
                                            + " JSON string but got `%s`",
                                    jsonObj.get("NetworkPruneReports").toString()));
                }
        ...
        if (jsonObj.get("PodPruneReport") != null && !jsonObj.get("PodPruneReport").isJsonNull()) {
            ...
            if (jsonArraypodPruneReport != null) {
                ...
                if (!jsonObj.get("PodPruneReport").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `PodPruneReport` to be an array in the JSON"
                                            + " string but got `%s`",
                                    jsonObj.get("PodPruneReport").toString()));
                }
        ...
        if (jsonObj.get("VolumePruneReports") != null
                && !jsonObj.get("VolumePruneReports").isJsonNull()) {
            ...
            if (jsonArrayvolumePruneReports != null) {
                ...
                if (!jsonObj.get("VolumePruneReports").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `VolumePruneReports` to be an array in the"
                                            + " JSON string but got `%s`",
                                    jsonObj.get("VolumePruneReports").toString()));
                }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<SystemPruneReport>() {
                        @Override
                        public void write(JsonWriter out, SystemPruneReport value)
                                throws IOException {
