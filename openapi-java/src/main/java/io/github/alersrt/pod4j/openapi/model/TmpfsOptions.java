...
public class TmpfsOptions {
    ...
    /**
     * Size sets the size of the tmpfs, in bytes. This will be converted to an operating system
     * specific value depending on the host. For example, on linux, it will be converted to use a
     * &#39;k&#39;, &#39;m&#39; or &#39;g&#39; syntax. BSD, though not widely supported with docker,
     * uses a straight byte value. Percentages are not supported.
     *
     * @return sizeBytes
     */
    @javax.annotation.Nullable
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TmpfsOptions.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in TmpfsOptions is not found in the empty"
                                        + " JSON string",
                                TmpfsOptions.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `TmpfsOptions` properties. JSON: %s",
