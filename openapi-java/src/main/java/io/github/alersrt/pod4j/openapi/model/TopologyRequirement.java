...
public class TopologyRequirement {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TopologyRequirement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format("The required field(s) %s in TopologyRequirement is not found in the empty JSON string", TopologyRequirement.openapiRequiredFields));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!TopologyRequirement.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TopologyRequirement` properties. JSON: %s", entry.getKey(), jsonElement));
            }
        }
    ...
    public String toString() {
        String sb = "class TopologyRequirement {\n" +
                "    preferred: " + toIndentedString(preferred) + "\n" +
                "    requisite: " + toIndentedString(requisite) + "\n" +
                "}";
        return sb;
    }
