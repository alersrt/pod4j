 ...
 */
@ApiModel(description = "WeightDevice is a structure that holds device:weight pair")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class WeightDevice implements Serializable {
  ...
  static {
     ...
     * @throws IOException if the JSON Object is invalid with respect to WeightDevice
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (WeightDevice.openapiRequiredFields.isEmpty()) {
                return;
            } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in WeightDevice is not found in the empty JSON string", WeightDevice.openapiRequiredFields.toString()));
            }
        }
      ...
      // check to see if the JSON string contains additional fields
        ...
        if (!WeightDevice.openapiFields.contains(entry.getKey())) {
            throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WeightDevice` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
