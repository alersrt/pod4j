...
public class VolumesApiTest {
    ...
    public void volumeCreateLibpodTest() throws ApiException {
        ...
        VolumeConfigResponse response = api.volumeCreateLibpod()
                .create(create)
                .execute();
    ...
    public void volumeListLibpodTest() throws ApiException {
        String filters = null;
        List<VolumeConfigResponse> response = api.volumeListLibpod()
                .filters(filters)
                .execute();
        // TODO: test validations
    }
    ...
    public void volumePruneLibpodTest() throws ApiException {
        String filters = null;
        List<PruneReport> response = api.volumePruneLibpod()
                .filters(filters)
                .execute();
        // TODO: test validations
    }
