...
import org.openapitools.client.model.CPUUsage;
import org.openapitools.client.model.ConmonInfo;
import org.openapitools.client.model.DistributionInfo;
import org.openapitools.client.model.IDMappings;
import org.openapitools.client.model.NetworkInfo;
import org.openapitools.client.model.OCIRuntimeInfo;
import org.openapitools.client.model.PastaInfo;
import org.openapitools.client.model.RemoteSocket;
import org.openapitools.client.model.SecurityInfo;
import org.openapitools.client.model.SlirpInfo;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HostInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HostInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
